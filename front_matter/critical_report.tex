...
\lastname{Haydn}
\shortname{M. Haydn}
\title{Pro Festo SS: Innocentium Vesperae}
\shorttitle{Vesperae}
\subtitle{Domine ad adiuvandum\\Dixit Dominus \textlt{MH 294}\\Confitebor \textlt{MH 304}\\Beatus vir \textlt{MH 304}\\De profundis \textlt{MH 304}\\Memento Domine \textlt{MH 200}\\Salvete flores \textlt{MH 307}\\Magnificat \textlt{MH 294}\\(D-Mbs Mus.ms. 451)}
\instrumentation{2 S, A (solo), 2 vl, b, org}
\maketitle
...
This edition bases upon a copy in the Bayerische Staatsbibliothek München. The digital version of the manuscript is available at \url{http://mdz-nbn-resolving.de/urn:nbn:de:bvb:12-bsb00051606-7} (siglum Mus.ms. 451; see also RISM ID 456009471).

In general, this edition closely follows the manuscript. Any changes that were introduced by the editor are indicated by italic type (lyrics, dynamics and directions), parentheses (expressive marks and bass figures) or dashes (slurs and ties). Accidentals are used according to modern conventions. Asterisks denote changes that are clarified in the detailed remarks below.\footnote{Abbreviations: A, alto; b, basses; Ms, manuscript; org, organ; r, rest; S, soprano; vl, violin.}
...
This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/haydn-m-vesperae-MH-200ff}. Your help will be greatly appreciated.
